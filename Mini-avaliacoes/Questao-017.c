/* Operadores Questão 17

Autor: Willian J. dos Santos
ano:   2021 

17) Faça um programa em C que calcule o consumo e a eficiência de um automóvel dados os dados de abastecimento, distância percorrida e preço por litro. 
